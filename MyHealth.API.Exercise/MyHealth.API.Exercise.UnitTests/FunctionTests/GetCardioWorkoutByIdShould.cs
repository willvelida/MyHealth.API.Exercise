...
{
    public class GetCardioWorkoutByIdShould
    {
        ...
        private GetCardioWorkoutById _func;

        public GetCardioWorkoutByIdShould()
        {
            ...
            _func = new GetCardioWorkoutById(
        ...
        [Fact]
        public async Task ReturnNoContentResultWhenCardioWorkoutIsNotFoundInLoggedWorkouts()
        {
            // Arrange
            var fixture = new Fixture();
            var workout = fixture.Create<mdl.ExerciseEnvelope>();
        ...
        [Fact]
        public async Task ReturnOkObjectResultWhenCardioExerciseIsFoundInExcerise()
        {
            // Arrange
            var fixture = new Fixture();
            var workout = fixture.Create<mdl.ExerciseEnvelope>();
            ...
            _exerciseDbServiceMock.Setup(x => x.GetWorkoutByDate(It.IsAny<string>())).ReturnsAsync(workout);
            _exerciseValidatorMock.Setup(x => x.ReturnCardioExercisesInExerciseEnvelope(It.IsAny<mdl.ExerciseEnvelope>())).Returns(workout.CardioExercises);
            _exerciseValidatorMock.Setup(x => x.GetCardioExerciseById(It.IsAny<List<mdl.CardioExercise>>(), It.IsAny<string>())).Returns(workout.CardioExercises[0]);

            // Act
            var response = await _func.Run(_httpRequestMock.Object, _loggerMock.Object, workout.Date, workout.WeightExercises[0].WeightExerciseId);
