...
{
    public class GetWeightWorkoutByIdShould
    {
        ...
        private GetWeightWorkoutById _func;

        public GetWeightWorkoutByIdShould()
        {
            ...
            _func = new GetWeightWorkoutById(
        ...
        [Fact]
        public async Task ReturnNoContentResultWhenWorkoutIsNotFoundInLoggedWorkouts()
        {
            // Arrange
            var fixture = new Fixture();
            var workout = fixture.Create<mdl.ExerciseEnvelope>();
        ...
        [Fact]
        public async Task ReturnOkObjectResultWhenWeightExerciseIsFoundInExcerise()
        {
            // Arrange
            var fixture = new Fixture();
            var workout = fixture.Create<mdl.ExerciseEnvelope>();
            ...
            _exerciseDbServiceMock.Setup(x => x.GetWorkoutByDate(It.IsAny<string>())).ReturnsAsync(workout);
            _exerciseValidatorMock.Setup(x => x.ReturnWeightExercisesInExerciseEnvelope(It.IsAny<mdl.ExerciseEnvelope>())).Returns(workout.WeightExercises);
            _exerciseValidatorMock.Setup(x => x.GetWeightExerciseById(It.IsAny<List<mdl.WeightExercise>>(), It.IsAny<string>())).Returns(workout.WeightExercises[0]);
