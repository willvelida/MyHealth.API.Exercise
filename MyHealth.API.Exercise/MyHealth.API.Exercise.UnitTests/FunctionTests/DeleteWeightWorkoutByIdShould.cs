...
{
    public class DeleteWeightWorkoutByIdShould
    {
        ...
        private DeleteWeightWorkoutById _func;

        public DeleteWeightWorkoutByIdShould()
        {
            ...
            _func = new DeleteWeightWorkoutById(
        ...
        public async Task ReturnNoContentResultWhenWorkoutIsFoundByHasNoWeightWorkoutsLogged()
        {
            ...
            workout.WeightExercises[0] = null;
        ...
        [Fact]
        public async Task ReturnNotFoundResultWhenWeightWorkoutToDeleteCantBeFound()
        {
            // Arrange
            var fixture = new Fixture();
            var workout = fixture.Create<mdl.ExerciseEnvelope>();
            ...
            _exerciseDbServiceMock.Setup(x => x.GetWorkoutByDate(It.IsAny<string>())).ReturnsAsync(workout);
            _exerciseValidatorMock.Setup(x => x.GetWeightExerciseById(It.IsAny<mdl.ExerciseEnvelope>(), It.IsAny<string>())).Returns(workout.WeightExercises[0]);
            _exerciseValidatorMock.Setup(x => x.RemoveWeightExerciseFromExerciseEnvelope(It.IsAny<mdl.ExerciseEnvelope>(), It.IsAny<mdl.WeightExercise>())).Returns(updatedWorkout);
        ...
        [Fact]
        public async Task ReturnNoContentResultWhenWeightExerciseHasBeenSuccessfullyDeleted()
        {
            var fixture = new Fixture();
            var workout = fixture.Create<mdl.ExerciseEnvelope>();
            workout.Date = "2021-08-29";
