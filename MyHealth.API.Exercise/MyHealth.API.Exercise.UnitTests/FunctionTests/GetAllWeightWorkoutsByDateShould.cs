...
{
    public class GetAllWeightWorkoutsByDateShould
    {
        ...
        private GetAllWeightWorkoutsByDate _func;

        public GetAllWeightWorkoutsByDateShould()
        {
            ...
            _func = new GetAllWeightWorkoutsByDate(
        ...
        [Fact]
        public async Task ReturnOkResultWhenWorkoutIsFoundByHasNoWeightWorkoutsLogged()
        {
            // Arrange
            var fixture = new Fixture();
            var workout = fixture.Create<mdl.ExerciseEnvelope>();
