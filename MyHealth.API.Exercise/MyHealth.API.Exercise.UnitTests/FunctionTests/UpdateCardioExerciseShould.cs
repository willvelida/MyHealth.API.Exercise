...
{
    public class UpdateCardioExerciseShould
    {
        ...
        private UpdateCardioExercise _func;

        public UpdateCardioExerciseShould()
        {
            ...
            _func = new UpdateCardioExercise(
        ...
        public async Task ReturnNotFoundResultWhenUpdatedWorkoutObjectCantBeFound()
        {
            ...
            _exerciseValidatorMock.Setup(x => x.UpdateCardioExerciseInExerciseEnvelope(It.IsAny<mdl.ExerciseEnvelope>(), It.IsAny<mdl.CardioExercise>())).Returns(updatedWorkout);
        ...
        [Fact]
        public async Task ReturnNoContentResultWhenCardioExerciseHasBeenSuccessfullyUpdated()
        {
            var fixture = new Fixture();
            var workout = fixture.Create<mdl.ExerciseEnvelope>();
            workout.Date = "2021-08-29";
